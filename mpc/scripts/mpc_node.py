...
class mpc_config:
    ...
    Rk: list = field(
        default_factory=lambda: np.diag([0.01, 5.0])               # Weights to more aggressively follow the line
    ...
    Qk: list = field(
        default_factory=lambda: np.diag([90, 90, 5.5, 26.0])        # Weights to more aggressively follow the line
